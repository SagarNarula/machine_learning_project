...
class DataValidation:
    ...
    def is_train_test_file_exists(self):
        try:
            logging.info("Checking if training and testing file are available or not")
    ...
    def validate_dataset_schema(self):
        try:
            ...
            #1. Number of Column
            #2. Check the value of Ocean Proximity(only acceptable values are allowed refer schema.yaml)
            #3. Column Names
